...
with io.open("emojilib/emojis.json", "rt", encoding="utf8") as emojifile:
    ...
    with open("emoji_fzf/emoji_fzf_emojilib.py", "w") as genfile:
        genfile.write(
            """\"\"\"
...
"""
        ...
        genfile.write("EMOJIS = {}".format(EMOJI_LIB_DATA))
...
setup(
    ...
    packages=["emoji_fzf"],
    entry_points={"console_scripts": ["emoji-fzf = emoji_fzf.emoji_fzf:main"]},
    classifiers=[
